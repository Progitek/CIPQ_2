HA$PBExportHeader$w_r_verrat_asortir.srw
forward
global type w_r_verrat_asortir from w_rapport
end type
end forward

global type w_r_verrat_asortir from w_rapport
string title = "Rapport - Liste des verrats entr$$HEX1$$e900$$ENDHEX$$s en production"
end type
global w_r_verrat_asortir w_r_verrat_asortir

on w_r_verrat_asortir.create
call super::create
end on

on w_r_verrat_asortir.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_verrat_asortir
string dataobject = "d_r_verrat_asortir"
end type
