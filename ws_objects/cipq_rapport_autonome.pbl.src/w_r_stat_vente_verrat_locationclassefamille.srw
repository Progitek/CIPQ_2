$PBExportHeader$w_r_stat_vente_verrat_locationclassefamille.srw
forward
global type w_r_stat_vente_verrat_locationclassefamille from w_rapport
end type
end forward
...
global w_r_stat_vente_verrat_locationclassefamille w_r_stat_vente_verrat_locationclassefamille

on w_r_stat_vente_verrat_locationclassefamille.create
call super::create
end on

on w_r_stat_vente_verrat_locationclassefamille.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_stat_vente_verrat_locationclassefamille
string dataobject = "d_r_stat_vente_verrat_locationclassefamille"
end type
