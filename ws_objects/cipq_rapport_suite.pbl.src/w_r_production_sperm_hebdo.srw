$PBExportHeader$w_r_production_sperm_hebdo.srw
forward
global type w_r_production_sperm_hebdo from w_rapport
end type
end forward
...
global w_r_production_sperm_hebdo w_r_production_sperm_hebdo
...
on w_r_production_sperm_hebdo.create
call super::create
end on

on w_r_production_sperm_hebdo.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_preview from w_rapport`dw_preview within w_r_production_sperm_hebdo
string dataobject = "d_r_production_sperm_hebdo"
end type
