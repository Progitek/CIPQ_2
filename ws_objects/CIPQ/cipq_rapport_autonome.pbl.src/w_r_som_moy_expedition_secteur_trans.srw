$PBExportHeader$w_r_som_moy_expedition_secteur_trans.srw
forward
global type w_r_som_moy_expedition_secteur_trans from w_rapport
end type
end forward
...
integer x = 214
integer y = 221
string title = "Rapport - Sommaire des moyennes des expéditions par secteur de transporteur"
end type
global w_r_som_moy_expedition_secteur_trans w_r_som_moy_expedition_secteur_trans

on w_r_som_moy_expedition_secteur_trans.create
call super::create
end on

on w_r_som_moy_expedition_secteur_trans.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_som_moy_expedition_secteur_trans
string dataobject = "d_r_som_moy_expedition_secteur_trans"
end type
