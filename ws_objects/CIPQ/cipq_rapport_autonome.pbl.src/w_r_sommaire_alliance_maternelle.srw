$PBExportHeader$w_r_sommaire_alliance_maternelle.srw
forward
global type w_r_sommaire_alliance_maternelle from w_rapport
end type
end forward

global type w_r_sommaire_alliance_maternelle from w_rapport
string title = "Rapport - Sommaire des produits de l~'Alliance maternelle"
end type
global w_r_sommaire_alliance_maternelle w_r_sommaire_alliance_maternelle

on w_r_sommaire_alliance_maternelle.create
call super::create
end on

on w_r_sommaire_alliance_maternelle.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_sommaire_alliance_maternelle
string dataobject = "d_r_sommaire_alliance_maternelle"
end type
