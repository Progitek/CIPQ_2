$PBExportHeader$w_r_stat_vente_race.srw
forward
global type w_r_stat_vente_race from w_rapport
end type
end forward

global type w_r_stat_vente_race from w_rapport
string title = "Rapport - Statistiques de ventes par race"
end type
global w_r_stat_vente_race w_r_stat_vente_race

on w_r_stat_vente_race.create
call super::create
end on

on w_r_stat_vente_race.destroy
call super::destroy
...
//#temp_sta_ven_rac_statfacture et #temp_sta_ven_rac_statfactureDetail
gnv_app.of_Cree_TableFact_Temp("temp_sta_ven_rac_statfacture")

//Première extraction
INSERT INTO #temp_sta_ven_rac_statfacture SELECT t_StatFacture.* 
FROM t_StatFacture 
...
//#temp_sta_ven_rac_statfactureDetail
INSERT INTO #temp_sta_ven_rac_statfactureDetail SELECT t_StatFactureDetail.* 
FROM #temp_sta_ven_rac_statfacture 
INNER JOIN t_StatFactureDetail 
ON (#temp_sta_ven_rac_statfacture.LIV_NO = t_StatFactureDetail.LIV_NO) 
AND (#temp_sta_ven_rac_statfacture.CIE_NO = t_StatFactureDetail.CIE_NO);
COMMIT USING SQLCA;
...
type dw_preview from w_rapport`dw_preview within w_r_stat_vente_race
string dataobject = "d_r_stat_vente_race"
end type
