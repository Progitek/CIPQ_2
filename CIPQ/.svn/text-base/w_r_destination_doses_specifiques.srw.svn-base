HA$PBExportHeader$w_r_destination_doses_specifiques.srw
forward
...
global type w_r_destination_doses_specifiques from w_rapport
string title = "Rapport - Destination des doses sp$$HEX1$$e900$$ENDHEX$$cifiques"
end type
...
//extraction du d$$HEX1$$e900$$ENDHEX$$tail '#temp_des_dos_spe_statfactureDetail'
