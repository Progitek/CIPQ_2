$PBExportHeader$w_r_expedition_cipq_produit.srw
forward
global type w_r_expedition_cipq_produit from w_rapport
end type
end forward

global type w_r_expedition_cipq_produit from w_rapport
string title = "Rapport - Expéditions CIPQ produit"
string menuname = "m_rapport_transfert"
event ue_transfertinternet ( )
end type
global w_r_expedition_cipq_produit w_r_expedition_cipq_produit

event ue_transfertinternet();//ue_transfertinternet
gnv_app.inv_transfert_internet.of_transfertexpheb( dw_preview, "semence CIPQ (produit)")
end event

on w_r_expedition_cipq_produit.create
call super::create
if IsValid(this.MenuID) then destroy(this.MenuID)
if this.MenuName = "m_rapport_transfert" then this.MenuID = create m_rapport_transfert
end on

on w_r_expedition_cipq_produit.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_expedition_cipq_produit
string dataobject = "d_r_expedition_cipq_produit"
end type
