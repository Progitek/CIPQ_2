$PBExportHeader$w_critere_date.srw
forward
...
w_r_lot_des_isolements_sommaire lw_lot_des_isolements_sommaire
...
CHOOSE CASE ls_retour
	...
	CASE "w_r_lot_des_isolements_sommaire"
		OpenSheet(lw_lot_des_isolements_sommaire, gnv_app.of_GetFrame(), 6, layered!)	
