$PBExportHeader$w_r_utilisation_medicament.srw
forward
global type w_r_utilisation_medicament from w_rapport
end type
end forward
...
global w_r_utilisation_medicament w_r_utilisation_medicament

on w_r_utilisation_medicament.create
call super::create
end on

on w_r_utilisation_medicament.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_utilisation_medicament
string dataobject = "d_r_utilisation_medicament"
end type
