$PBExportHeader$w_r_recolte_detaillee.srw
forward
global type w_r_recolte_detaillee from w_rapport
end type
end forward
...
integer x = 214
integer y = 221
string title = "Rapport - Récoltes détaillées"
end type
global w_r_recolte_detaillee w_r_recolte_detaillee

on w_r_recolte_detaillee.create
call super::create
end on

on w_r_recolte_detaillee.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_recolte_detaillee
string dataobject = "d_r_recolte_detaillee"
end type
