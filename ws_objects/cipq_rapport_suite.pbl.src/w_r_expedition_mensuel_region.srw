$PBExportHeader$w_r_expedition_mensuel_region.srw
forward
global type w_r_expedition_mensuel_region from w_rapport
end type
end forward

global type w_r_expedition_mensuel_region from w_rapport
end type
global w_r_expedition_mensuel_region w_r_expedition_mensuel_region

on w_r_expedition_mensuel_region.create
call super::create
end on

on w_r_expedition_mensuel_region.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_expedition_mensuel_region
string dataobject = "d_r_expedition_mensuel_region"
end type
