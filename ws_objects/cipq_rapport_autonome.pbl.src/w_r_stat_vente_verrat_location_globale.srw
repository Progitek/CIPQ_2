$PBExportHeader$w_r_stat_vente_verrat_location_globale.srw
forward
global type w_r_stat_vente_verrat_location_globale from w_rapport
end type
end forward
...
global w_r_stat_vente_verrat_location_globale w_r_stat_vente_verrat_location_globale

on w_r_stat_vente_verrat_location_globale.create
call super::create
end on

on w_r_stat_vente_verrat_location_globale.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_stat_vente_verrat_location_globale
string dataobject = "d_r_stat_vente_verrat_location_globale"
end type
