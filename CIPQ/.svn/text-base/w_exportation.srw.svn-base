HA$PBExportHeader$w_exportation.srw
forward
...
this.Control[iCurrent+1]=this.cb_annuler
this.Control[iCurrent+2]=this.cb_ok
this.Control[iCurrent+3]=this.rb_html
this.Control[iCurrent+4]=this.rb_sql
this.Control[iCurrent+5]=this.rb_csv
this.Control[iCurrent+6]=this.rb_xls
...
integer height = 68
long backcolor = 15793151
string text = "Texte s$$HEX1$$e900$$ENDHEX$$par$$HEX2$$e9002000$$ENDHEX$$par des virgules (CSV)"
end type
