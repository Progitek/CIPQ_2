$PBExportHeader$w_r_plan_verraterie_centre_verrat.srw
forward
global type w_r_plan_verraterie_centre_verrat from w_rapport
end type
end forward

global type w_r_plan_verraterie_centre_verrat from w_rapport
end type
global w_r_plan_verraterie_centre_verrat w_r_plan_verraterie_centre_verrat

on w_r_plan_verraterie_centre_verrat.create
call super::create
end on

on w_r_plan_verraterie_centre_verrat.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_plan_verraterie_centre_verrat
string dataobject = "d_r_plan_verraterie_centre_verrat"
end type
