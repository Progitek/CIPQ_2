$PBExportHeader$w_r_com_orig_exp_produit.srw
forward
global type w_r_com_orig_exp_produit from w_rapport
end type
end forward
...
integer x = 214
integer y = 221
string title = "Rapport - Commandes originales vs expédiées par produit"
end type
global w_r_com_orig_exp_produit w_r_com_orig_exp_produit

on w_r_com_orig_exp_produit.create
call super::create
end on

on w_r_com_orig_exp_produit.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_com_orig_exp_produit
string dataobject = "d_r_com_orig_exp_produit"
end type
