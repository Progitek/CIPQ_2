$PBExportHeader$w_r_liste_males_a_recolter_disponibles.srw
forward
global type w_r_liste_males_a_recolter_disponibles from w_rapport
end type
end forward
...
integer x = 214
integer y = 221
string title = "Rapport - Liste des mâles à récolter disponibles"
end type
global w_r_liste_males_a_recolter_disponibles w_r_liste_males_a_recolter_disponibles

on w_r_liste_males_a_recolter_disponibles.create
call super::create
end on

on w_r_liste_males_a_recolter_disponibles.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_liste_males_a_recolter_disponibles
string dataobject = "d_r_liste_males_a_recolter_disponibles"
end type
