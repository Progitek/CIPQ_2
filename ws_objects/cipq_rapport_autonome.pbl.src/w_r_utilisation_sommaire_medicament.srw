$PBExportHeader$w_r_utilisation_sommaire_medicament.srw
forward
global type w_r_utilisation_sommaire_medicament from w_rapport
end type
end forward

global type w_r_utilisation_sommaire_medicament from w_rapport
string title = "Rapport - Utilisation des médicaments"
end type
global w_r_utilisation_sommaire_medicament w_r_utilisation_sommaire_medicament

on w_r_utilisation_sommaire_medicament.create
call super::create
end on

on w_r_utilisation_sommaire_medicament.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_utilisation_sommaire_medicament
string dataobject = "d_r_utilisation_sommaire_medicament"
end type
