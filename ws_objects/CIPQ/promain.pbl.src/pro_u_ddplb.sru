$PBExportHeader$pro_u_ddplb.sru
$PBExportComments$(PRO) Extension DropDownListBox class
forward
global type pro_u_ddplb from pfc_u_ddplb
end type
end forward

global type pro_u_ddplb from pfc_u_ddplb
end type
global pro_u_ddplb pro_u_ddplb
...
if ai_index > 0 then event selectionChanged(ai_index)
...
if li_index > 0 then event selectionChanged(li_index)

return li_index

end function

on pro_u_ddplb.create
call super::create
end on

on pro_u_ddplb.destroy
call super::destroy
end on
