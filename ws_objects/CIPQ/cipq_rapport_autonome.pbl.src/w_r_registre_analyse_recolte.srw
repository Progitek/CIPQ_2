$PBExportHeader$w_r_registre_analyse_recolte.srw
forward
global type w_r_registre_analyse_recolte from w_rapport
end type
end forward
...
integer x = 214
integer y = 221
string title = "Rapport - Régistre des analyses de récoltes"
end type
global w_r_registre_analyse_recolte w_r_registre_analyse_recolte

on w_r_registre_analyse_recolte.create
call super::create
end on

on w_r_registre_analyse_recolte.destroy
call super::destroy
...
gnv_app.of_doregistreanalyserecolte( ld_de, ld_au)
...
type dw_preview from w_rapport`dw_preview within w_r_registre_analyse_recolte
string dataobject = "d_r_registre_analyse_recolte"
end type
