$PBExportHeader$w_r_destination_produits_super_famille.srw
forward
global type w_r_destination_produits_super_famille from w_rapport
end type
end forward

global type w_r_destination_produits_super_famille from w_rapport
string title = "Rapport - Destination des produits par super famille"
end type
global w_r_destination_produits_super_famille w_r_destination_produits_super_famille

on w_r_destination_produits_super_famille.create
call super::create
end on

on w_r_destination_produits_super_famille.destroy
call super::destroy
...
//#temp_des_pro_sufa_statfacture et #temp_des_pro_sufa_statfactureDetail
gnv_app.of_Cree_TableFact_Temp("temp_des_pro_sufa_statfacture")

//Première extraction
INSERT INTO #temp_des_pro_sufa_statfacture 
...
//extraction du détail '#temp_des_pro_sufa_statfactureDetail'
INSERT INTO #temp_des_pro_sufa_statfactureDetail SELECT t_StatFactureDetail.* 
...
type dw_preview from w_rapport`dw_preview within w_r_destination_produits_super_famille
string dataobject = "d_r_destination_produits_super_famille"
end type
