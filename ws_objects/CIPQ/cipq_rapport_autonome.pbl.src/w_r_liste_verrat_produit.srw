$PBExportHeader$w_r_liste_verrat_produit.srw
forward
global type w_r_liste_verrat_produit from w_rapport
end type
end forward
...
integer x = 214
integer y = 221
string title = "Rapport - Liste des verrats avec produits"
end type
global w_r_liste_verrat_produit w_r_liste_verrat_produit

on w_r_liste_verrat_produit.create
call super::create
end on

on w_r_liste_verrat_produit.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_liste_verrat_produit
string dataobject = "d_r_liste_verrat_produit"
end type
