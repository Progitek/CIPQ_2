HA$PBExportHeader$w_r_stat_vente_verrat_heberge.srw
forward
global type w_r_stat_vente_verrat_heberge from w_rapport
end type
end forward

global type w_r_stat_vente_verrat_heberge from w_rapport
string title = "Rapport - Statistiques de ventes par verrats h$$HEX1$$e900$$ENDHEX$$berg$$HEX1$$e900$$ENDHEX$$s"
end type
global w_r_stat_vente_verrat_heberge w_r_stat_vente_verrat_heberge

on w_r_stat_vente_verrat_heberge.create
call super::create
end on

on w_r_stat_vente_verrat_heberge.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_stat_vente_verrat_heberge
string dataobject = "d_r_stat_vente_verrat_heberge"
end type
