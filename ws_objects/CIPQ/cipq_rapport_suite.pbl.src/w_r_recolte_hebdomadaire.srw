$PBExportHeader$w_r_recolte_hebdomadaire.srw
forward
global type w_r_recolte_hebdomadaire from w_rapport
end type
end forward

global type w_r_recolte_hebdomadaire from w_rapport
end type
global w_r_recolte_hebdomadaire w_r_recolte_hebdomadaire
...
on w_r_recolte_hebdomadaire.create
call super::create
end on

on w_r_recolte_hebdomadaire.destroy
call super::destroy
if IsValid(MenuID) then destroy(MenuID)
end on

type dw_preview from w_rapport`dw_preview within w_r_recolte_hebdomadaire
string dataobject = "d_r_recolte_hebdomadaire"
end type
