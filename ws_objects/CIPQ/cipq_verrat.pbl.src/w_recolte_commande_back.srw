$PBExportHeader$w_recolte_commande_back.srw
forward
global type w_recolte_commande_back from w_sheet_frame
end type
type rr_1 from roundrectangle within w_recolte_commande_back
end type
type st_1 from statictext within w_recolte_commande_back
end type
type em_date from u_em within w_recolte_commande_back
end type
type uo_toolbar from u_cst_toolbarstrip within w_recolte_commande_back
end type
type cb_masquer from commandbutton within w_recolte_commande_back
end type
type cb_minuterie from commandbutton within w_recolte_commande_back
end type
type em_derniere from u_em within w_recolte_commande_back
end type
type dw_gestion_recolte_commande from u_dw within w_recolte_commande_back
end type
type st_exp from statictext within w_recolte_commande_back
end type
type gb_1 from groupbox within w_recolte_commande_back
end type
type cbx_exporter from u_cbx within w_recolte_commande_back
end type
type cb_zero from commandbutton within w_recolte_commande_back
end type
type ddlb_1 from u_ddlb within w_recolte_commande_back
end type
end forward
...
global w_recolte_commande_back w_recolte_commande_back
...
on w_recolte_commande_back.create
int iCurrent
call super::create
...
on w_recolte_commande_back.destroy
call super::destroy
...
type st_title from w_sheet_frame`st_title within w_recolte_commande_back
integer x = 192
integer y = 52
integer width = 2162
...
type p_8 from w_sheet_frame`p_8 within w_recolte_commande_back
integer x = 46
integer y = 40
integer width = 133
integer height = 112
...
type rr_infopat from w_sheet_frame`rr_infopat within w_recolte_commande_back
integer y = 32
integer height = 128
end type
