...
event open;call super::open;//Récupérer les paramètres
...
st_nbreleveur.text = "Nombre d'éléveurs: " + string(ll_any)
end event
...
uo_toolbar.of_AddItem("Rechercher un éleveur...", "Search!")
...
tab_eleveur.tabpage_eleveur_info.uo_toolbar_haut_gauche.of_AddItem("Ajouter un téléphone", "AddWatch5!")
tab_eleveur.tabpage_eleveur_info.uo_toolbar_haut_gauche.of_AddItem("Supprimer un téléphone", "DeleteWatch5!")
...
tab_eleveur.tabpage_eleveur_info.uo_toolbar_bas.of_AddItem("Ajouter un éleveur", "C:\ii4net\CIPQ\images\ajout_personne.ico")
tab_eleveur.tabpage_eleveur_info.uo_toolbar_bas.of_AddItem("Supprimer un éleveur", "C:\ii4net\CIPQ\images\suppr_personne.ico")
