$PBExportHeader$w_r_comp_recolte_liv_heb.srw
forward
global type w_r_comp_recolte_liv_heb from w_rapport
end type
end forward

global type w_r_comp_recolte_liv_heb from w_rapport
string title = "Rapport - Comparaison des récoltes et des livraisons par hébergeur"
end type
global w_r_comp_recolte_liv_heb w_r_comp_recolte_liv_heb

on w_r_comp_recolte_liv_heb.create
call super::create
end on

on w_r_comp_recolte_liv_heb.destroy
call super::destroy
...
gnv_app.of_docompilationrecolte(ld_de, ld_au)
...
type dw_preview from w_rapport`dw_preview within w_r_comp_recolte_liv_heb
string dataobject = "d_r_comp_recolte_liv_heb"
end type
