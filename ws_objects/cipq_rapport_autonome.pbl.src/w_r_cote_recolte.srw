$PBExportHeader$w_r_cote_recolte.srw
forward
global type w_r_cote_recolte from w_rapport
end type
end forward

global type w_r_cote_recolte from w_rapport
string title = "Rapport - Cotes de récolte de verrat"
end type
global w_r_cote_recolte w_r_cote_recolte

on w_r_cote_recolte.create
call super::create
end on

on w_r_cote_recolte.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_cote_recolte
string dataobject = "d_r_cote_recolte"
end type
