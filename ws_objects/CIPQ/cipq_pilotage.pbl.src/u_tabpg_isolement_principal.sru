$PBExportHeader$u_tabpg_isolement_principal.sru
forward
...
//	2007-10-04	Mathieu Gendron	Création
//
//////////////////////////////////////////////////////////////////////////////
...
IF row > 0 THEN
	CHOOSE CASE dwo.name
		CASE "datesortie"
			...
			//Mettre à jour les dates de sortie de verrat
...
event rowfocuschanged;call super::rowfocuschanged;IF currentrow > 0 THEN
	...
	//Désactiver le tabpg en fonction de la date
