$PBExportHeader$w_r_sommaire_lignes_maternelles_coop.srw
forward
global type w_r_sommaire_lignes_maternelles_coop from w_rapport
end type
end forward

global type w_r_sommaire_lignes_maternelles_coop from w_rapport
string title = "Rapport - Sommaire lignés maternelles COOP"
end type
global w_r_sommaire_lignes_maternelles_coop w_r_sommaire_lignes_maternelles_coop

on w_r_sommaire_lignes_maternelles_coop.create
call super::create
end on

on w_r_sommaire_lignes_maternelles_coop.destroy
call super::destroy
...
type dw_preview from w_rapport`dw_preview within w_r_sommaire_lignes_maternelles_coop
string dataobject = "d_r_sommaire_lignes_maternelles_coop"
end type
